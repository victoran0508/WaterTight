...
<div class="container">
    <h3 class="title5">塗装工事施工実績</h3>
    <div class="row">
        <div class="col-md-6"><img src="<?php echo get_template_directory_uri(); ?>/images/paint/catch.png" alt="塗装工事実績" class="img-responsive mb20 img-cnt"/></div>
        <div class="col-md-6">
            <div class="workbox2">
