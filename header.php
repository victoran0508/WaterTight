...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-46059229-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
 
  gtag('config', 'UA-46059229-2');
</script>
    <?php wp_head(); ?>
</head>
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-4 headttl">
                    <h1>神奈川県川崎市周辺の屋上防水工事・マンション大規模修繕工事・改修工事のエキスパート</h1>
                </div>
        ...
        <nav class="navbar">
            <div class="container">
                <div class="navbar-header">
					...
					<div class="sp_menu">
					<a href="#"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button></a>
					</div>
